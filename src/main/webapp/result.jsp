            ...
            <%@ page import="java.util.List" %>
                ...
                <body>
                    <div class="container">
                        ...
                        <% AdSuggestionService.SuggestionResult suggestionResult=(AdSuggestionService.SuggestionResult)
                            request.getAttribute("suggestionResult"); String
                            suggestion=suggestionResult.getSuggestion(); String reason=suggestionResult.getReason();
                            List<String> evidenceUrls = suggestionResult.getEvidenceUrls();
                            String encodedAdType = (String) request.getAttribute("encodedAdType");
                            String diagnosisJson = new com.google.gson.Gson().toJson(new java.util.HashMap<String,
                                Object>() {{
                                ...
                                %>
                                <script>
                                    window.diagnosisInfo = JSON.parse('<%= diagnosisJson.replace("'", "\\'") %>');
                                </script>
                                ...
                                <% if (evidenceUrls !=null && !evidenceUrls.isEmpty()) { %>
                                    ...
                                    <% } %>
                                        ...
                                        <% if (encodedAdType !=null && !encodedAdType.isEmpty()) { %>
                                            <a class="custom-button" href="simulation.jsp?adType=<%= encodedAdType %>"
